<form method="POST" action="javascript:;" id="formModalAddNew" enctype="multipart/form-data"> 
    ...
    <div class="row">
        ...
        <div class="col-xxl-2 col-xl-2 col-lg-4 col-md-6 col-sm-12">
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-xs-6 form-check" style="margin-left: 10px;">
                    <input type="radio" value="1" class="form-check-input" name="root_mode" id="form-root_mode-1" > 
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-xs-6 form-check">
                    <input type="radio" value="0" class="form-check-input" name="root_mode" id="form-root_mode-2" checked=""> 
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-top-10">
            ...
            <span class="input-with-icon  right">
                <i class=""></i>
                <textarea  class="form-control"  name="text" id="text" name="text"></textarea>
            </span>
        </div>  
