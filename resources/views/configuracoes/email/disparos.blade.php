...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                                                ...
                                                <table class="table dt-responsive nowrap table-condensed table-hover table-full-width" id="listingData">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-priority="4">Referência</th>
                                                            <th data-priority="5">Email</th>
                                                            <th data-priority="6">Assunto</th>
                                                            <th data-priority="7">Estado</th>
                                                            <th data-priority="8">Cadastrado</th>
    ...
    <script>
        ...
        window.action = {};
        window.action['resend'] = <?php print $data['actions']['resend'] ? "true" : "false"; ?>;
        window.action['preview'] = <?php print $data['actions']['preview'] ? "true" : "false"; ?>;
        window.action['remove'] = <?php print $data['actions']['remove'] ? "true" : "false"; ?>;
    </script>
    <!-- tinymce js -->
    <script src="{{ asset('assets/libs/ckeditor/ckeditor.js') }}"></script> 
    <script src="{{ asset('assets/js/pages/configuracao/email/disparos.init.js') }}"></script>  
</html>
