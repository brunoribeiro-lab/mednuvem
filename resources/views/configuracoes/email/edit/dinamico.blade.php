    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12">
            ...
            <span class="input-with-icon right">
                <i class=""></i>
                <input class="form-control" id="index" name="index" type="text" value="{{ $data->index }}" />
            </span>
        </div> 
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <span class="input-with-icon right">
                <i class=""></i>
                <input class="form-control" id="subject" name="subject" type="text" value="{{ $data->subject }}" />
            </span>
        </div>  
        <div class="col-md-12 margin-top-10"> 
            <div class="form-group">
                ...
                <div class="input-with-icon  right">
                    <i class=""></i>
                    <div id="editor">{!! $data->message !!}</div>
                    <textarea id="email" hidden="" name="email" required="">{!! $data->message !!}</textarea>
                </div>
            </div>
        </div>
        <div class="col-md-12">
