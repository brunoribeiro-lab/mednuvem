...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                                                ...
                                                <table class="table dt-responsive nowrap table-condensed table-hover table-full-width" id="listingData">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-priority="4">Identificação</th>
                                                            <th data-priority="5">Assunto</th>
                                                            <th data-priority="6">Cadastrado</th>
    ...
    <script src="{{ asset('assets/js/pages/configuracao/email/dinamico.init.js') }}"></script>  
</html>
