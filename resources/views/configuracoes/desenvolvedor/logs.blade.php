...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                                                ...
                                                <table class="table dt-responsive nowrap table-condensed table-hover table-full-width" id="listingData">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-priority="4">Cód</th>
                                                            <th data-priority="5">Canal</th>
                                                            <th data-priority="6">Cód. Erro</th>
                                                            <th data-priority="7">Mensagem</th>
                                                            <th data-priority="8">Contexto</th>
                                                            <th data-priority="9">Cadastrado</th>
    ...
    <script src="{{ asset('assets/js/pages/configuracao/desenvolvedor/logs.init.js') }}"></script>   
</html>
