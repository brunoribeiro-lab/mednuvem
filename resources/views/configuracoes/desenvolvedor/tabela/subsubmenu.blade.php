<div class="col-md-12">
    <h3><a href="javascript:;" id="backTo2"><i class="fa fa-arrow-left"></i> Voltar</a></h3>
    <hr>
</div>
<table class="table dt-responsive nowrap table-condensed table-hover table-full-width" id="listingDataSubSubmenu"  data-submenu="{{ $submenu }}">
    <thead>
        <tr>
