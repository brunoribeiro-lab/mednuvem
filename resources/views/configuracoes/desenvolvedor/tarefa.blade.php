...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                                                ...
                                                <table class="table dt-responsive nowrap table-condensed table-hover table-full-width" id="listingData">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-priority="3">Tarefa</th>
                                                            <th data-priority="2">Saúde</th>
                                                            <th data-priority="4">Comando</th>
                                                            <th data-priority="5">Última Execução</th>
                                                        </tr>
                                                    </thead>
    ...
    <script src="{{ asset('assets/js/pages/configuracao/desenvolvedor/tarefa.init.js') }}"></script>  
</html>
