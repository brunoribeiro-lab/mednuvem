        ...
        var contato = ({
            ...
            setarErros: function (json, form) {
                ...
                $.each(json.errors, function (k, v) {
                    ...
                    } else if (proximo.is("div.input-group")) {
                    ...
                    } else if (proximo[0].className === 'btn btn-primary shadow-none ms-0 password-addon') {
                        $(form + " #" + k).next().after('<div class="invalid-feedback">' + v + '</div>');
                    } else {
                        console.log("else", proximo);
                        ...
                        if (!$(form).data('beenSubmitted')) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.error) {
                                        $this.message(data.message, 'danger', 'Erro ao salvar');
                                        callBackErro();
                                    } else {
                                        $this.message(data.message, 'success', 'Salvo com sucesso');
                                        callbackSucess(data);
                                    }
                                },
                                error: function (data) {
            ...
            init: function () {
                ...
                var callbackSucess = function (json) {
                ...
                this.validate("#nova-senha-form", 'recuperar-senha/nova-senha', callbackSucess, callBackErro, validation);
            }
        }.init());
    });
})(jQuery);
