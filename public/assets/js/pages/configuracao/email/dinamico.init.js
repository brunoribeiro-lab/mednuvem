...
var email_dinamico = ({
    singular: "Email Dinâmico",
    plural: "Emails Dinâmicos",
    pageAjax: 'SGS/configuracoes/email/dinamicos/',
    endpoints: {
        'listing': 'listar',
        'remove': 'remover',
        'preview': 'ver',
        ...
        $.get(getEndpoint, function (html) {
            ...
            if (form) {
                ...
                editor.on('change', function (evt) {
                    ...
                    $(form + " #email").html(evt.editor.getData());
                });
    ...
    tabelaEmailsDinamicos: function () {
        var $this = this;
        let buttons = [{
                "sExtends": "add_new",
