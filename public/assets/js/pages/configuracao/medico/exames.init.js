...
var exames = ({
    singular: "Exame",
    plural: "Exames",
    pageAjax: 'SGS/configuracoes/medico/exames/',
    endpoints: {
        'listing': 'listar',
        'listing-funcoes': 'listar-funcoes',
        'remove': 'remover',
        'preview': 'ver',
        'get-add': 'add',
        'insert': 'add',
        ...
        $.get(getEndpoint, function (html) {
            ...
            if (form) {
                ...
                $(form + ' #setor').change(function () {
                    ...
                    $.get($this.pageAjax + $this.endpoints['listing-funcoes'] + "/" + $(this).val(), function (json) {
                        if (!json.error) {
